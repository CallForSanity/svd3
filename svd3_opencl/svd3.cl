...
// from https://github.com/ericjang/svd3
void svd(// input A
        ...
        float* V)
{
    ...
    // output U
    float *u11 = &U[0]; float *u12 = &U[1]; float *u13 = &U[2];
    float *u21 = &U[3]; float *u22 = &U[4]; float *u23 = &U[5];
    float *u31 = &U[6]; float *u32 = &U[7]; float *u33 = &U[8];
    // output S
    //float *s11 = S[0]; float *s12 = S[1]; float *s13 = S[2];
    //float *s21 = S[3]; float *s22 = S[4]; float *s23 = S[5];
    //float *s31 = S[6]; float *s32 = S[7]; float *s33 = S[8];
    float *s11 = &S[0]; float *s12 = &S[1]; float *s13 = &S[2];
    float *s21 = &S[3]; float *s22 = &S[4]; float *s23 = &S[5];
    float *s31 = &S[6]; float *s32 = &S[7]; float *s33 = &S[8];
    // output V
    float *v11 = &V[0]; float *v12 = &V[1]; float *v13 = &V[2];
    float *v21 = &V[3]; float *v22 = &V[4]; float *v23 = &V[5];
    float *v31 = &V[6]; float *v32 = &V[7]; float *v33 = &V[8];
...
__kernel void svdArrayTest(__global const float* A, __global float* U, __global float* S, __global float* V)
{
	float A_[9],U_[9],S_[9],V_[9];
	for (size_t j = 0; j < 9; ++j)
		A_[j] = A[j];
	svdArray(A_,U_,S_,V_);
